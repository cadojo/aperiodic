...
date: 7/4/21
description: "*An introduction to dynamics through scientific
  software.*"
...
-   [Dynamics](#dynamics){#toc-dynamics}
-   [Example](#example){#toc-example}
    -   [Model
        Construction](#model-construction){#toc-model-construction}
    -   [Coding our Model](#coding-our-model){#toc-coding-our-model}
    -   [Simulating our
        Model](#simulating-our-model){#toc-simulating-our-model}
